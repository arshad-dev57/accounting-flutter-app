...
class _AgedReceivablesScreenState extends State<AgedReceivablesScreen> {
      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 4),
            Text(
              '${filtered.length} customers will be exported',
        ...
        children: [
          ...
          pw.Row(
            ...
            children: [
              _pdfSummaryItem(
                '31-60 Days',
                _formatAmount(total31to60),
                PdfColors.orange700,
              ),
              _pdfSummaryItem(
                '61-90 Days',
                _formatAmount(total61to90),
                PdfColors.deepOrange700,
              ),
              _pdfSummaryItem(
                '90+ Days',
                _formatAmount(totalOver90),
                PdfColors.red700,
              ),
            ],
          ),
          pw.SizedBox(height: 8),
          pw.Text(
            'As at: ${DateFormat('dd MMM yyyy').format(_asAtDate)}  •  Filter: $_selectedFilter',
  ...
  pw.Widget _pdfCustomersTable(List<AgedCustomer> customers) {
    return pw.Column(
            ...
            child: pw.Row(
              children: [
                ...
                pw.Expanded(
                  flex: 2,
                  child: pw.Text(
                    _formatAmount(c.totalOutstanding),
                    textAlign: pw.TextAlign.right,
                    style: pw.TextStyle(
                      fontSize: 8,
                      fontWeight: pw.FontWeight.bold,
