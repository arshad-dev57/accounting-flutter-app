// lib/core/warehouse/sales_payment/views/sales_payment_screen.dart
...
class SalesPaymentScreen extends StatelessWidget {
  const SalesPaymentScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(SalesPaymentController());
  ...
  void _showDetail(BuildContext context, SalesPaymentController controller, SalesPaymentModel item) {
...
class _SearchField extends StatefulWidget {
  final SalesPaymentController controller;
        ...
        if (controller.selectedInvoices.isNotEmpty) ...[
          _section('Payment Details', [
            ...
            DropdownButtonFormField<String>(
              ...
              items: SalesPaymentController.paymentMethods
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('Outstanding: ${_format(customer['outstandingBalance']?.toDouble() ?? 0)}'),
        ],
      ),
    );
  }

  Widget _invoiceTile(InvoiceForPayment invoice, bool isSelected) {
        ...
        children: [
          ...
          Expanded(
            ...
            child: ElevatedButton(
              onPressed: controller.isSubmitting.value || !controller.canReceivePayment
                  ? null
...
class _PaymentDetailSheet extends StatefulWidget {
  final SalesPaymentController controller;
  final SalesPaymentModel paymentItem;
...
class _PaymentListView extends StatelessWidget {
  ...
  final ValueChanged<SalesPaymentModel> onView;
