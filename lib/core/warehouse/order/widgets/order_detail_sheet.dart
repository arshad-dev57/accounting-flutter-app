        ...
        child: Column(
          ...
          children: [
            ...
            if (order.expectedDeliveryDate != null)
              _row(
                'Expected Delivery',
                controller.formatDate(order.expectedDeliveryDate!),
              ),
            ...
            Text(
              order.shippingAddressText.isEmpty
                  ? '-'
            ...
            Text(
              order.billingAddressText.isEmpty ? '-' : order.billingAddressText,
            ),
            ...
            _row(
              'Discount',
              '- ${controller.formatCurrency(order.discountTotal)}',
            ),
            _row(
              'Grand Total',
            ...
            if (order.tags.isNotEmpty) _row('Tags', order.tags.join(', ')),
            const SizedBox(height: 16),
            SizedBox(
