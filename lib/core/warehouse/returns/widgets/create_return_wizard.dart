            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  const Expanded(
                    child: Text('Create Return', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800)),
                  ),
                ],
              ),
            ),
    ...
    Widget _stepDetails() {
      return _section('Step 3: Return Details', [
        DropdownButtonFormField<String>(
          ...
          decoration: const InputDecoration(labelText: 'Return Type', border: OutlineInputBorder()),
          ...
          children: [
            ...
            Expanded(
              child: TextField(
                ...
                keyboardType: const TextInputType.numberWithOptions(decimal: true),
                decoration: const InputDecoration(labelText: 'Shipping Cost', border: OutlineInputBorder()),
                onChanged: (_) => controller.lineDrafts.refresh(),
              ),
            ),
          ],
        ...
        child: Row(
          children: [
            if (controller.wizardStep.value > 0)
              OutlinedButton(onPressed: controller.previousStep, child: const Text('Back')),
            const Spacer(),
