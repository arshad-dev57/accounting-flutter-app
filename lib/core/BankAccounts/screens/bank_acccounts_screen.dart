            ...
            child: Obx(() {
              ...
              return Column(
                children: [
                  ...
                  Expanded(
                    child: _buildMobileBankAccountsList(controller, context),
                  ),
                ],
              );
            }),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: () =>
                        _showAddAccountDialog(context, controller, context),
                    child: Container(
                      width: 36,
                      height: 36,
                      decoration: BoxDecoration(
              ...
              children: [
                Expanded(
                  child: _buildSummaryTile(
                    label: 'Total Balance',
                    value: _formatAmount(controller.totalBalance.value),
              ...
              children: [
                Expanded(
                  child: _buildSummaryTile(
                    ...
                    value: _formatAmount(controller.total$.value),
                ...
                Expanded(
                  child: _buildSummaryTile(
                    label: 'USD Balance',
                    value: _formatAmount(controller.totalUSD.value),
                ...
                Row(
                  children: [
                    Expanded(
                      child: _amountBox(
                        label: 'OPENING',
                        value: _formatAmount(account.openingBalance),
                    ...
                    Expanded(
                      child: _amountBox(
                        label: 'CURRENT',
                        value: _formatAmount(account.currentBalance),
                        color: balancePositive ? kSuccess : kDanger,
                      ),
                    ),
                  ],
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: OutlinedButton.icon(
                        onPressed: () =>
                            _showAddMoneyDialog(context, controller, account),
                        icon: Icon(Icons.add_card, size: 14, color: kPrimary),
                        label: Text(
                          'Add Money',
                          style: TextStyle(
                            fontSize: 11,
                    ...
                    Expanded(
                      child: ElevatedButton.icon(
                        onPressed: () => controller.transferMoney(account),
                        icon: const Icon(
                          Icons.swap_horiz,
                          size: 14,
                          color: Colors.white,
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          final tiles = [
            _buildWebKpiTile(
              'Total Balance',
              _formatAmount(controller.totalBalance.value),
              kSuccess,
              Icons.account_balance_rounded,
            ),
            _buildWebKpiTile(
              '${CurrencyUtils.code} Balance',
              _formatAmount(controller.total$.value),
              const Color(0xFF9B59B6),
              Icons.currency_exchange_rounded,
            ),
            _buildWebKpiTile(
              'USD Balance',
              _formatAmount(controller.totalUSD.value),
              kWarning,
                ...
                child: Column(
                  children: [
                    ...
                    _detailRow(
                      'Status',
                      account.status,
                      valueColor: account.status == 'Active'
                          ? kSuccess
                          : kDanger,
                    ),
                  ],
      ...
      builder: (ctx) {
        return StatefulBuilder(
          builder: (ctx, setLocal) {
            ...
            return AlertDialog(
              title: Text('Add Money · ${account.accountName}'),
              content: SizedBox(
                width: 420,
                child: loading
                    ? const SizedBox(
                ...
                ElevatedButton(
                  onPressed: submitting
                      ...
                      : () async {
                          ...
                          final ok = await controller.depositToBankAccount(
                          ...
                          if (!ok) setLocal(() => submitting = false);
                        },
                  child: Text(submitting ? 'Posting…' : 'Post Deposit'),
                ),
              ],
            );
          },
