...
class BillsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (supplierId != null &&
        ...
        controller.filterBySupplier(exists ? supplierId! : '');
      }
    });
  ...
  Widget _buildTopHeader(BuildContext context, BillController controller) {
    return Container(
      color: kPrimary,
      child: SafeArea(
        bottom: false,
  ...
  Widget _buildSummaryCards(BillController controller) {
    return Obx(
      () => Container(
  ...
  Widget _buildListView(BillController controller, BuildContext context) {
    return Obx(() {
