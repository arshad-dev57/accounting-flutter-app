              ...
              Wrap(
                ...
                children: [
                  _ChipDropdown(
                    ...
                    items: SalesReportController.channels,
                    onChanged: controller.setChannel,
                  ),
                  _ChipDropdown(
                    label: 'Period',
                    value: controller.period.value,
                    items: SalesReportController.periods,
                    onChanged: controller.setPeriod,
                  ),
                  _ChipDropdown(
                    label: 'Status',
                    value: controller.status.value,
                    items: SalesReportController.statuses,
    ...
    return Obx(() {
      ...
      return Row(
        children: [
          ...
          const SizedBox(width: 8),
          chip('pos', const Color(0xFF059669)),
          const SizedBox(width: 8),
          chip('invoices', const Color(0xFFD97706)),
        ],
      );
    });
  }
    ...
    return Obx(() {
      if (controller.rows.isEmpty) {
        return Container(
          ...
          child: const Center(child: Text('No sales found for these filters')),
        );
      }
              ...
              Container(
                ...
                child: const Row(
                  children: [
                    ...
                    Expanded(flex: 16, child: Text('Customer', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 12))),
            ...
            ...controller.rows.map((r) {
              if (isMobile) {
                return ListTile(
                  ...
                  subtitle: Text(
                    '${controller.formatDate(r.date)} · ${r.channel.toUpperCase()} · ${r.customerName}',
                    style: TextStyle(fontSize: 11, color: Colors.grey.shade600),
                  ),
                  trailing: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
              ...
              return Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(flex: 16, child: Text(r.customerName, style: const TextStyle(fontSize: 12), overflow: TextOverflow.ellipsis)),
