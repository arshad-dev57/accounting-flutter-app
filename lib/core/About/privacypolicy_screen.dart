      ...
      child: Column(
        children: [
          ...
          _buildSection(
            ...
            icon: Icons.history,
            content:
                'We retain your data as long as your account is active. If you delete your account, we will delete your personal data within 30 days, except where we are required to retain it for legal or legitimate business purposes.',
          ),
          _buildSection(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildWebSection(
                  ...
                  icon: Icons.history,
                  content:
                      'We retain your data as long as your account is active. If you delete your account, we will delete your personal data within 30 days, except where we are required to retain it for legal or legitimate business purposes (e.g., tax records retention of 7 years).',
                ),
                const SizedBox(height: 24),
                _buildWebSection(
                  title: '8. Children\'s Privacy',
                  icon: Icons.child_care,
                  content:
                      'The Platform is not intended for children under 13 years of age. We do not knowingly collect personal information from children under 13. If you believe we have collected such information, please contact us immediately.',
                ),
                const SizedBox(height: 24),
                _buildWebSection(
                  title: '9. International Data Transfers',
                  icon: Icons.public,
                  content:
                      'Your information may be transferred to and processed in countries other than your own. We ensure appropriate safeguards are in place to protect your data in accordance with this Privacy Policy, including standard contractual clauses where required.',
                ),
                const SizedBox(height: 24),
                _buildWebSection(
                  title: '10. Cookies and Tracking',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'At BisonsTechs, we are committed to protecting your privacy and securing your financial data. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our platform.',
            style: TextStyle(
              fontSize: 14,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          Text(
            'At BisonsTechs Pro, we are committed to protecting your privacy and securing your financial data. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our mobile application.',
            style: TextStyle(
              fontSize: 13,
