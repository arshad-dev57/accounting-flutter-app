...
class InvoicesScreen extends StatelessWidget {
  ...
  Widget _buildMobileInvoicesList(
    InvoiceController controller,
    BuildContext context,
  ) {
    return Obx(() {
        ...
        return Center(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () =>
                    _showCreateInvoiceDialog(context, controller, context),
                    ...
                    if (invoice.status != 'Paid') ...[
                      ...
                      Expanded(
                        child: ElevatedButton.icon(
                          onPressed: () =>
                              _recordPayment(invoice, controller, context),
                          icon: const Icon(
                            Icons.payment,
                            size: 14,
                            color: Colors.white,
      ...
      builder: (ctx) => Dialog(
        ...
        child: Container(
          ...
          constraints: BoxConstraints(
            maxHeight: MediaQuery.of(ctx).size.height * (isWeb ? 0.88 : 0.92),
          ),
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
                  ...
                  children: [
                    Expanded(
                      child: OutlinedButton.icon(
                        onPressed: () {
                          Navigator.pop(ctx);
                          _exportSingleInvoice(invoice, controller, context);
                        },
                        icon: const Icon(Icons.download_outlined, size: 16),
                        label: Text(
                          'Export',
                          style: TextStyle(fontSize: isWeb ? 13 : 11),
                        ),
                        style: OutlinedButton.styleFrom(
        ...
        content: Column(
          ...
          children: [
            ListTile(
              ...
              trailing: Obx(
                () => Switch(
                  value: controller.selectedFilter.value == 'Unpaid',
                  onChanged: (v) {
                    Navigator.pop(ctx);
            ...
            ListTile(
              ...
              trailing: Obx(
                () => Switch(
                  value: controller.selectedFilter.value == 'Overdue',
                  onChanged: (v) {
                    Navigator.pop(ctx);
            ...
            ListTile(
              ...
              trailing: Obx(
                () => Switch(
                  value: controller.selectedFilter.value == 'Paid',
                  onChanged: (v) {
                    Navigator.pop(ctx);
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            ListTile(
              leading: const Icon(Icons.picture_as_pdf, color: kDanger),
            ...
            ListTile(
              leading: const Icon(Icons.table_chart, color: kSuccess),
  ...
  Widget _totalsRow(String label, String value, bool isWeb, {Color? color}) {
    return Row(
      ...
      children: [
        Text(
          label,
          style: TextStyle(fontSize: isWeb ? 13 : 11, color: color ?? kSubText),
        ),
        Text(
          value,
          style: TextStyle(
